...
import org.openhab.binding.tuya.internal.MilightBindingConstants;
import org.openhab.binding.tuya.internal.handler.BridgeHandlerConfig;
import org.openhab.binding.tuya.internal.protocol.MilightV6SessionManager;
import org.openhab.binding.tuya.internal.protocol.MilightV6SessionManager.ISessionState;
import org.openhab.binding.tuya.internal.protocol.MilightV6SessionManager.SessionState;
 ...
 */
@NonNullByDefault
@Component(service = DiscoveryService.class, immediate = true, configurationPid = "discovery.tuya")
public class TuyaDiscovery extends AbstractDiscoveryService implements Runnable {
    private final Logger logger = LoggerFactory.getLogger(TuyaDiscovery.class);
    ...
    public TuyaDiscovery() throws IllegalArgumentException, UnknownHostException {
    ...
    private class SendDiscoverRunnable implements Runnable {
        ...
        private void sendDiscover(InetAddress destIP) {
            if (ENABLE_V3) {
                ...
                discoverPacketV3.setPort(TuyaBindingConstants.PORT_DISCOVER);
                try {
